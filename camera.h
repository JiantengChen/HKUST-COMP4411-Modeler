...
public:
    ...
    inline void frameAll()
    {
        ...
        // +		mLookAt	{n=0x007cf510 {0.09999895, 0.529236019, -0.107281998} }	Vec3<float>
        ...
        mPosition = Vec3f(1.69059706f, 10.286596000f, 24.0636921f);
        mLookAt = Vec3f(0.09999895f, 3.529236019f, -0.107281998f);
