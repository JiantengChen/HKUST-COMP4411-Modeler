...
void ModelerView::draw()
{
	...
	lightPosition1[0] = VAL(LIGHT1X);
	lightPosition1[1] = VAL(LIGHT1Y);
	lightPosition1[2] = VAL(LIGHT1Z);

	lightDiffuse1[0] = VAL(LIGHT1R);
	lightDiffuse1[1] = VAL(LIGHT1G);
	lightDiffuse1[2] = VAL(LIGHT1B);
